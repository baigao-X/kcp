...
do
    ...
    function parse_udp_video(start, msg_type, kcp_data_len, buf, pkt, root)
        ...
        local rtp_payload = (second_byte_value & 0x7F)-- or second_byte_value >> 1 -- require lua 5.3
        local rtp_marker = (second_byte_value >> 7)-- or second_byte_value & 1 -- require lua 5.3
        ...
        local indicator_type = (indicator & 0x1F)
        local fu_start = 0
        local fu_end = 0
